 ...
 */
 ...
 func (c *NVMeTCPConnector) ConnectVolume(ctx context.Context, info NVMeTCPTargetInfo) (Device, error) {
 ...
 func addDefaultNVMeTCPPortToVolumeInfoPortals(info *ISCSIVolumeInfo) {
	 for i, t := range info.Targets {
 ...
 func (c *NVMeTCPConnector) validateNVMeTCPVolumeInfo(ctx context.Context, info ISCSIVolumeInfo) error {
